...
class Index extends Component
{
    ...
    public function fetchData($args)
    {
        $this->target = $args;
        if ($args == 'Junk') {
            $this->categories = Category::onlyTrashed()->where('service', ServiceType::BUY)->get();
        } else {
            $this->categories = Category::where('service', ServiceType::BUY)->where('status', $args)->get();
        }
    ...
    {
        return view('livewire.admin.buy.category.index')->layout('layouts.admin');
    }
