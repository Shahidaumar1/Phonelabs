...
class Index extends Component
{
    ...
    public function fetchData($args)
    {
        $this->target = $args;
        if ($args == 'Junk') {
            $this->devices = $this->selectedCategory ? DeviceType::onlyTrashed()->where('service', ServiceType::BUY)->get() : [];
        } else {
    ...
    {
        return view('livewire.admin.buy.device.index')->layout('layouts.admin');
    }
}