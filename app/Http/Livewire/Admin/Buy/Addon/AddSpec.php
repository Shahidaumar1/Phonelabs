...
// If you want to apply a condition, it needs to be done differently, possibly like this:
$new_product_spec->condition = $this->selectedCondition;
        ...
        $new_product_spec->service = ServiceType::BUY;
    ...
    public function loadSpecsData()
    {
        ...
        $this->grades = ['A', 'B', 'C'];
        $this->conditions = ['Brand-new','Excellent', 'Good', 'Fair', 'Poor', 'Faulty'];
    ...
    {
        return view('livewire.admin.buy.addon.add-spec');
    }
}
