...
class OtherTablets extends Component
{
    public $faults;
    ...
    public function updated()
    {
        ...
        $this->alert = false;
        session()->put('other_tablet_data', $other_tablet_data);


    }
    public function render()
    {
        return view('livewire.guest.others.other-tablets')->layout('frontend.layouts.app');
    }
