...
class OtherLaptops extends Component
{
    ...
    public function updated()
    {
        ...
        $this->alert = false;
        session()->put('other_laptop_data', $other_laptop_data);


    }
    public function render()
    {
        return view('livewire.guest.others.other-laptops')->layout('frontend.layouts.app');
    }
