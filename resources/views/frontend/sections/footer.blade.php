...
.footer-box .newsLetter-input button:hover{
                ...
                <div class="row pb-4 pb-md-5">
                    ...
                    <div class="col-sm-6 col-lg-3 col-xl-4">
                        ...
                        <div class="footer-logo-box">
                            ...
                            <a href="/"><h4>{{ $head_branch->name }}</h4></a>

                            <p>Your trusted {{$head_branch->name}} partners in UK. Welcome to {{$head_branch->name}}</p>
                            ...
                            <a target="_blank" href="{{ $siteSettings->twitter_link }}" class="twitter">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="footer-box">
                            ...
                            <a class="nav-link" href="{{ route('guest-accessories-products') }}">Accessories</a>
                        </li>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="footer-box">
                            ...
                            <ul class="footer-panel">
                                ...
                                <li><a href="{{ route('privacy-and-policy') }}" class="footer-link">Privacy Policy</a>
                                
                                <li><a href="{{ route('terms-and-conditions') }}" class="footer-link">Terms &
    ...
    <li><a href="{{ route('stores') }}" class="footer-link">Stores</a></li>
                        ...
                        <div class="footer-box">
                            ...
                            <ul class="footer-panel">
                                ...
                                <li>
                                    ...
                                    <a href="{{ $siteSettings->google_map_profile_link }}" target="_blank"

                                        class="footer-link">{{ $head_branch->address_line_1 . ' ' . $head_branch->address_line_2 . ' ' . $head_branch->town_city . ' ' . $head_branch->post_code }}</a>
        ...
        <!--                <p class="mb-0">Copyright © 2025 {{$head_branch->name}} - All Rights Reserved.</p>-->

                        <!--<div>-->

                        <!--    <a href="{{ route('terms-and-conditions') }}" class="me-3">Terms and conditions</a>-->
    ...
    <div class="px-2 px-sm-3">
        ...
        <div class="custom-container">
            ...
            <div class="copy-write-content text-center d-flex justify-content-center align-items-center">
                ...
                <p class="mb-0">Copyright © 2026 {{$head_branch->name}} - All Rights Reserved - <a href="https://softaccess.co.uk/">Powered by SoftAccess</a></p>
