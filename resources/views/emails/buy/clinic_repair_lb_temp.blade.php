                            ...
                            <tr>
                                ...
                                <td>
                                    <span>
                                        ...
                                        {{ $data['selectedBranch']['address_line_1'] ?? '' }},
                                        {{ $data['selectedBranch']['address_line_2'] ?? '' }}
                                        {{ !empty($data['selectedBranch']['address_line_2']) ? ',' : '' }}
                                        {{ $data['selectedBranch']['town_city'] ?? '' }},
                                        {{ $data['selectedBranch']['post_code'] ?? '' }},
                                        UK
                                    </span>
                                </td>
                            </tr>
