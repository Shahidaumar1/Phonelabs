<div>
    <div class="d-flex">
        ...
        <x-content>
            <livewire:admin.buy.components.top-nav active="devices" />
                   ...
                   <div class="d-flex align-items-center  justify-content-center my-4">               
                    ...
                    <div class="card bg-white cursor-pointer">
                        <div class="p-2 d-flex justify-content-center align-items-center">
                            <a href="{{ route('buy-models', $device) }}">
                            <img src="{{ $device->file ?? '#' }}" class="img-fluid" style="height: 140px; width: 200px" />
                        </a>
...
<div class="button-sticky container bg-blue d-lg-none d-md-none">
    ...
    <x-modal title="Add Device" id="add-buy-device">
        <livewire:admin.buy.device.create :category="$selectedCategory" />
    </x-modal>
    @endif
    <x-modal title="Edit Device" id="edit-buy-device">
        <livewire:admin.buy.device.edit />
    </x-modal>
</div>