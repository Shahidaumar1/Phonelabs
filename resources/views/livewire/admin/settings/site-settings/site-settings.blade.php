                ...
                <div class="mt-5">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            ...
                            @error('siteSetting.buisness_name') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            @error('siteSetting.website_url') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                         <div class="col-md-4">
                ...
                <div class="row mt-3 justify-content-center">
                    ...
                    <div class="row mt-3 justify-content-center">
                        <div class="col-md-8">
                            ...
                            @error('siteSetting.fb_link') <span class="text-danger">{{ $message }}</span> @enderror
                    ...
                    <div class="row mt-3 justify-content-center">
                        <div class="col-md-8">
                            ...
                            @error('siteSetting.insta_link') <span class="text-danger">{{ $message }}</span> @enderror
                            <div class="form-check form-switch mt-2">
                    ...
                    <div class="row mt-3 justify-content-center">
                        <div class="col-md-8">
                            ...
                            @error('siteSetting.linkedin_link') <span class="text-danger">{{ $message }}</span> @enderror
                            <div class="form-check form-switch mt-2">
                    ...
                    <div class="row mt-3 justify-content-center">
                        <div class="col-md-8">
                            ...
                            @error('siteSetting.twitter_link') <span class="text-danger">{{ $message }}</span> @enderror
                            <div class="form-check form-switch mt-2">
                    ...
                    <div class="row mt-3 justify-content-center">
                        <div class="col-md-8">
                            ...
                            @error('siteSetting.tiktok_link') <span class="text-danger">{{ $message }}</span> @enderror
                            <div class="form-check form-switch mt-2">
                    ...
                    <div class="row mt-3 justify-content-center">
                        <div class="col-md-8">
                            ...
                            @error('siteSetting.snapchat_link') <span class="text-danger">{{ $message }}</span> @enderror
                            <div class="form-check form-switch mt-2">
...
<livewire:admin.settings.google-reviews.manage-google-reviews />
                    ...
                    <div class="row mt-3 justify-content-center">
                        <div class="col-md-8">
                            ...
                            @error('siteSetting.map_link') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
            ...
            <div class="m-4">{!! $siteSetting->map_link !!}</div>
            <div class="row mt-3 justify-content-center">
