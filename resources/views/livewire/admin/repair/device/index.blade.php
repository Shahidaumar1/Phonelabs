<div>
    <div class="d-flex">
        ...
        <x-content>
            <livewire:admin.repair.components.top-nav active="devices" />
            <div class="container mt-2">
                    <h3 class = "text-start">{{ $selectedCategory->name ?? '' }}</h3>
                    ...
                    @forelse($devices as $device)
                        <div class="card  cursor-pointer">
                            ...
                            <div class="p-2 d-flex justify-content-center align-items-center">
                             ...
                             <a href="{{ route('repair-models', $device) }}"
                            class="">
...
<div class="button-sticky container bg-blue d-lg-none d-md-none">
    ...
    {{-- OTHER MODALS --}}
    @if ($selectedCategory)
        <x-modal title="Add Device" id="add-repair-device">
            <livewire:admin.repair.device.create :category="$selectedCategory" />
        </x-modal>
    @endif
    <x-modal title="Edit Device" id="edit-repair-device">
        <livewire:admin.repair.device.edit />
    </x-modal>
