                ...
                @if (isset($responseData['knownAddresses']) && count($responseData['knownAddresses']) > 0)
                    <div class="address-list-container">
                        ...
                        <div class="address-list">
                            @foreach ($responseData['knownAddresses'] as $index => $address)
                                <div class="address-item" 
                                     wire:click="selectedAddress = '{{ addslashes($address) }}'"
                                     style="cursor: pointer;">
                                    <div class="address-radio">
                                        <div class="custom-radio {{ $selectedAddress === $address ? 'selected' : '' }}">
            ...
            <div class="form-column">
                ...
                <div class="input-group-modern">
                    ...
                    <div class="slot-cards">
                        <div class="slot-card {{ $collection['repair_slot'] === '11am - 2pm' ? 'active' : '' }}" 
                        ...
                        <div class="slot-card {{ $collection['repair_slot'] === '2pm - 5pm' ? 'active' : '' }}" 
                        ...
                        <div class="slot-card {{ $collection['repair_slot'] === '5pm - 8pm' ? 'active' : '' }}" 
