<div>{{-- Single root element — required by Livewire --}}
    ...
    <div class="postal-repair-sec">
        <div class="cust-container" style="max-width: 1200px; margin: 0 auto; padding: 20px;">
            ...
            {{-- 
                x-data: step controls which section shows.
                selectedBranchId initialized from Livewire's pre-selected value.
            --}}
            <form x-data="{ step: 0, selectedBranchId: {{ $selectedBranchId ?? 'null' }} }"
                  class="submit-form"
                ...
                <div class="repair-sec-1" x-show="step === 0" x-cloak x-transition.opacity>
                    ...
                    <div class="repair-sec1-inner">
                        ...
                        <div class="reair-sec1-box1">
                            @forelse ($branches as $branch)
                                <label class="branch-option">
                                    {{-- Radio syncs with both Alpine and Livewire --}}
                                    <input
                                        type="radio"
                                        name="branch_id"
                                        value="{{ $branch->id }}"
                                        ...
                                        @change="$wire.selectBranch({{ $branch->id }})">
                        ...
                        <div class="repair1-box2">
                            @if (isset($siteBranch) && $siteBranch && !empty($siteBranch->map_link))
                                {!! $siteBranch->map_link !!}
                            @else
