            ...
            <div class="col-md-6 mx-auto mb-2">
                ...
                <form wire:submit.prevent="create" method="POST">
                    ...
                    <div class="d-flex justify-content-end">
                        <button class="btn btn-primary" type="submit" {{ $image ? '' : 'disabled' }}> Add
                            Modal</button>
                    </div>
                </form>
            </div>
