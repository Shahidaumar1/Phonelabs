...
<div style="margin: 0; padding: 0; width: 100%; max-width: 100vw; overflow-x: hidden; box-sizing: border-box;">
    ...
    {{-- DESKTOP MENU BAR                               --}}
    {{-- ═══════════════════════════════════════════════ --}}
    <div class="web-menu-bar d-none d-lg-block" x-data="{ open: false, hover: false }" @mouseleave="@this.call('hideDevices')">
               ...
               <div class="mega-nav-wrapper">
                   ...
                   <ul class="mx-auto main-menus">
                        ...
                        <li class="nav-item navList" @mouseenter="open = true; hover = true"
                            ...
                            <a class="nav-link"
                                @mouseenter="@this.call('showDevices', 'Repair')"
                                href="{{ route($routeMapping['repair']) }}">
                                {!! $webContent->mega_nav_repair !!}
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item navList">
                            <a class="nav-link" href="{{ route('guest-buy-products') }}">Buy a Device</a>
                        </li>
                        @endif
                    ...
                    <div class="mega-nav-btns">
                        <a href="tel:{{ $head_branch->landline_number }}" class="mega-nav-phone">
                            ...
                            <span>{{ $head_branch->landline_number }}</span>
                        </a>
