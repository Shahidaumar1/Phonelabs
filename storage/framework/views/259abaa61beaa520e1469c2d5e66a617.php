...
} elseif ($_instance->childHasBeenRendered('l2431833438-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2431833438-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2431833438-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2431833438-0');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2431833438-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/livewire/guest/buy/product-specs.blade.php ENDPATH**/ ?>