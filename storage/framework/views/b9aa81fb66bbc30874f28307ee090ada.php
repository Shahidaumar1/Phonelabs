...
} elseif ($_instance->childHasBeenRendered('l970238061-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l970238061-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l970238061-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l970238061-0');
} else {
    $response = \Livewire\Livewire::mount('components.top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('l970238061-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('l970238061-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l970238061-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l970238061-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l970238061-1');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', ['theme' => 'white']);
    $html = $response->html();
    $_instance->logRenderedChild('l970238061-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /home/phonelabs/public_html/resources/views/livewire/guest/repair-types.blade.php ENDPATH**/ ?>