<div>
                ...
                <div class="select-device-box">
                    <div class="input-group">
                        ...
                        <select id="category" onchange="updateDeviceTypeOptions()">
                            ...
                            <?php $__currentLoopData = $repairCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        const deviceTypesData = <?php echo json_encode($allDeviceTypes, 15, 512) ?>;
        const modalsData = <?php echo json_encode($allModals, 15, 512) ?>;
        ...
        function redirectToRepairTypes() {
            ...
            const url = "<?php echo e(url('')); ?>" + '/' + deviceTypeId + '/' + modalId + '/repair_types';
            window.location.href = url;
        }
    </script>
</div><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/frontend/Home_page_sections/selectAdeviceSection.blade.php ENDPATH**/ ?>