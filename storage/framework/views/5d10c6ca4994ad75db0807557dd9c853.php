...
} elseif ($_instance->childHasBeenRendered('l995653233-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l995653233-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l995653233-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l995653233-0');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l995653233-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /home/phonelabs/public_html/resources/views/livewire/guest/categories.blade.php ENDPATH**/ ?>