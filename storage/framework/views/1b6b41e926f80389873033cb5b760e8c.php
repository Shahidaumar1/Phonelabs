...
} elseif ($_instance->childHasBeenRendered('l1030336960-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1030336960-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1030336960-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1030336960-0');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', ['theme' => 'white']);
    $html = $response->html();
    $_instance->logRenderedChild('l1030336960-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <style>
                    ...
                    <div class="repair-grid">
                        ...
                        <div class="info-section">
                            <div class="info-point">
                                ...
                                <div class="point-content">
                                    ...
                                    <span class="point-value"><?php echo e($data['modal']['name'] ?? ''); ?></span>
                                </div>
                            </div>
                            <div class="info-point">
                                ...
                                <div class="point-content">
                                    ...
                                    <span class="point-value"><?php echo e($data['repair_type']['name'] ?? ''); ?></span>
                                </div>
                            </div>
                            <div class="info-point">
                        ...
                        <div class="device-section">
                            <div class="device-image-wrapper">
                                <img src="<?php echo e(asset($data['modal']['file'] ?? '')); ?>"
                        ...
                        <div class="right-section">
                            ...
                            <div class="price-section">
                                ...
                                <div class="price-amount">
                                    ...
                                    <span class="price-number"><?php echo e(number_format($totalPrice ?? 0, 2)); ?></span>
                                </div>
                            </div>

                            
                            <?php if($showProtector || $showCover): ?>
                            <div class="addon-box">
                                <span class="addon-title">Add-ons</span>

                                <?php if($showProtector): ?>
                                <label class="addon-item <?php echo e($protectorSelected ? 'selected' : ''); ?>">
                                    <input type="checkbox"
                                           wire:click="toggleProtector"
                                           <?php echo e($protectorSelected ? 'checked' : ''); ?>>
                                    <div>
                                        <span class="addon-item-name">Glass Protector</span>
                                        <span class="addon-item-price">Add at half price (+£<?php echo e(number_format($protectorPrice, 2)); ?>)</span>
                                    </div>
                                </label>
                                <?php endif; ?>

                                <?php if($showCover): ?>
                                <label class="addon-item <?php echo e($coverSelected ? 'selected' : ''); ?>">
                                    <input type="checkbox"
                                           wire:click="toggleCover"
                                           <?php echo e($coverSelected ? 'checked' : ''); ?>>
                                    <div>
                                        <span class="addon-item-name">Phone Cover</span>
                                        <span class="addon-item-price">Add at half price (+£<?php echo e(number_format($coverPrice, 2)); ?>)</span>
                                    </div>
                                </label>
                                <?php endif; ?>
                            </div>
...
?>
    ...
    let currentStep = <?php echo e($currentStep ?? 0); ?>;
...
</div><?php /**PATH /home/phonelabs/public_html/resources/views/livewire/guest/repair-detail.blade.php ENDPATH**/ ?>