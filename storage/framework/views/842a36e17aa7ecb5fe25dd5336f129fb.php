<div>
    <div class="d-flex flex-column gap-3">
        <div>
            <input placeholder="Enter name" type="text" required wire:model.debounce.500="device.name" /><br>
            <?php $__errorArgs = ['device.name'];
...
<?php /**PATH /home/phonelabs/public_html/resources/views/livewire/admin/accessories/device/edit.blade.php ENDPATH**/ ?>