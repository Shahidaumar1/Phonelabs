...
} elseif ($_instance->childHasBeenRendered('6mHVFBW')) {
    $componentId = $_instance->getRenderedChildComponentId('6mHVFBW');
    $componentTag = $_instance->getRenderedChildComponentTagName('6mHVFBW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6mHVFBW');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', ['theme' => 'white']);
    $html = $response->html();
    $_instance->logRenderedChild('6mHVFBW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/repairguide.blade.php ENDPATH**/ ?>