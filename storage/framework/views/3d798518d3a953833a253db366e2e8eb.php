...
} elseif ($_instance->childHasBeenRendered('l2114942404-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2114942404-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2114942404-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2114942404-0');
} else {
    $response = \Livewire\Livewire::mount('admin.components.side-nave', ['active' => 'accessories']);
    $html = $response->html();
    $_instance->logRenderedChild('l2114942404-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes([]); ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.accessories.components.top-nav', ['active' => 'models'])->html();
} elseif ($_instance->childHasBeenRendered('l2114942404-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2114942404-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2114942404-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2114942404-1');
} else {
    $response = \Livewire\Livewire::mount('admin.accessories.components.top-nav', ['active' => 'models']);
    $html = $response->html();
    $_instance->logRenderedChild('l2114942404-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="container">
...
} elseif ($_instance->childHasBeenRendered('l2114942404-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2114942404-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2114942404-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2114942404-2');
} else {
    $response = \Livewire\Livewire::mount('admin.accessories.components.sub-nav', ['items' => $items]);
    $html = $response->html();
    $_instance->logRenderedChild('l2114942404-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                     ...
                     <?php endif; ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex gap-2">
                                <i class="fa fa-square cursor-pointer <?php echo e($activeView == 'card' ? 'text-success' : ''); ?>" aria-hidden="true" wire:click="activateView('card')"></i>
                                <i class="fa fa-list cursor-pointer <?php echo e($activeView == 'list' ? 'text-success' : ''); ?>" aria-hidden="true" wire:click="activateView('list')"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="d-flex justify-content-center gap-4  flex-wrap  " wire:sortable="updateOrderNumber">
                        ...
                        class="card border-0 rounded-4 " wire:sortable.item="<?php echo e($model->id); ?>" wire:key="model-<?php echo e($model->id); ?>">
                            <div class="p-2 d-flex justify-content-between align-items-center">
                                <?php if($target != 'Junk'): ?>
                                <div class="form-check form-switch">
                                    <input type="checkbox" role="switch" class="form-check-input" wire:change="toggleStatus(<?php echo e($model->id); ?>)" <?php echo e($model->status == 'Publish' ? 'checked' : ''); ?>>
                                </div>
                                <?php endif; ?>
                                <div class="dropdown dropend" id="<?php echo e(uniqid()); ?>" wire:ignore>
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="<?php echo e(uniqid()); ?>">
                                        <li>
                                            <?php if($target != 'Junk'): ?>
                                            <a class="dropdown-item" href="javascirpt:void(0)" wire:click="selectModel('<?php echo e($model->id); ?>')">Edit</a>
                                            <?php endif; ?>
                                        </li>
                                        <li>
                                            <?php if($target != 'Junk'): ?>
                                            <a class="dropdown-item" href="javascirpt:void(0)" wire:click="setTopRated('<?php echo e($model->id); ?>')"><?php echo e($model->top_rated ? 'Unset Top Rated' : 'Set Top Rated'); ?>
                                        ...
                                        <li>
                                            <?php if($target != 'Junk'): ?>
                                            <a class="dropdown-item" href="javascirpt:void(0)" wire:click="setNewArrival('<?php echo e($model->id); ?>')">
                                                <?php echo e($model->new_arrival ? 'Unset New Arrival' : 'Set New Arrival'); ?></a>
                                            <?php endif; ?>
                                        </li>
                                        <li>
                                            <?php if($target == 'Junk'): ?>
                                            <a class="dropdown-item" wire:click="restore('<?php echo e($model->id); ?>')">Restore</a>
                                            <?php else: ?>
                                            <a class="dropdown-item" wire:click="softDelete('<?php echo e($model->id); ?>')">Delete</a>
                                            <?php endif; ?>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <a href="<?php echo e(route('accessories-models-add-ons')); ?>" class="position-relative">
                                <img src="<?php echo e($model->file ?? '#'); ?>" class="img-fluid" style="cursor: move; height: 100px; margin: 0px 62px;" />
                                <div class="p-2">
                        ...
                        <table class="table mx-auto p-5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-switch">
                                            <input type="checkbox" role="switch" class="form-check-input" wire:change="toggleStatus(<?php echo e($model->id); ?>)" <?php echo e($model->status == 'Publish' ? 'checked' : ''); ?> <?php echo e($target == 'Junk' ? 'disabled' : ''); ?>>
                                        </div>
                                    </td>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Add Model','id' => 'add-buy-model']); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.accessories.model.create', ['device' => $selectedDevice])->html();
} elseif ($_instance->childHasBeenRendered('l2114942404-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l2114942404-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2114942404-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2114942404-3');
} else {
    $response = \Livewire\Livewire::mount('admin.accessories.model.create', ['device' => $selectedDevice]);
    $html = $response->html();
    $_instance->logRenderedChild('l2114942404-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Model','id' => 'edit-buy-model']); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.accessories.model.edit', [])->html();
} elseif ($_instance->childHasBeenRendered('l2114942404-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l2114942404-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2114942404-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2114942404-4');
} else {
    $response = \Livewire\Livewire::mount('admin.accessories.model.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2114942404-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /home/phonelabs/public_html/resources/views/livewire/admin/accessories/model/index.blade.php ENDPATH**/ ?>