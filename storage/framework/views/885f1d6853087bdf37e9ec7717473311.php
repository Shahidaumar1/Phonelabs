    ...
    <div class="banner-custom-container">
        <div class="content-box">
            ...
            <div class="cta-group">
                ...
                <a href="tel:<?php echo e($head_branch->landline_number ?? ''); ?>" class="btn-main quote-btn">
                    <i class="fa-solid fa-receipt"></i> Get Quote
                </a>
            </div>
            <div class="location-info">
                <i class="fa-solid fa-location-dot"></i> 
                <span><?php echo e($head_branch->town_city ?? 'Our Location'); ?>, <?php echo e($head_branch->post_code ?? ''); ?></span>
            </div>
        </div>
    </div>
</section><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/frontend/Home_page_sections/banner.blade.php ENDPATH**/ ?>