...
} elseif ($_instance->childHasBeenRendered('l123619953-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l123619953-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l123619953-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l123619953-0');
} else {
    $response = \Livewire\Livewire::mount('admin.components.side-nave', ['active' => 'accessories']);
    $html = $response->html();
    $_instance->logRenderedChild('l123619953-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l123619953-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l123619953-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l123619953-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l123619953-1');
} else {
    $response = \Livewire\Livewire::mount('admin.accessories.components.top-nav', ['active' => 'categories']);
    $html = $response->html();
    $_instance->logRenderedChild('l123619953-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="container">
...
} elseif ($_instance->childHasBeenRendered('l123619953-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l123619953-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l123619953-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l123619953-2');
} else {
    $response = \Livewire\Livewire::mount('admin.accessories.components.sub-nav', ['items' => $items]);
    $html = $response->html();
    $_instance->logRenderedChild('l123619953-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
} elseif ($_instance->childHasBeenRendered('l123619953-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l123619953-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l123619953-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l123619953-3');
} else {
    $response = \Livewire\Livewire::mount('admin.accessories.category.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('l123619953-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l123619953-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l123619953-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l123619953-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l123619953-4');
} else {
    $response = \Livewire\Livewire::mount('admin.accessories.category.grade-text', []);
    $html = $response->html();
    $_instance->logRenderedChild('l123619953-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l123619953-5')) {
    $componentId = $_instance->getRenderedChildComponentId('l123619953-5');
    $componentTag = $_instance->getRenderedChildComponentTagName('l123619953-5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l123619953-5');
} else {
    $response = \Livewire\Livewire::mount('admin.accessories.category.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l123619953-5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /home/phonelabs/public_html/resources/views/livewire/admin/accessories/category/index.blade.php ENDPATH**/ ?>