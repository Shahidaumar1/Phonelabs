...
<body>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p class="m-0 fs-5"> Hi <span style=" font-weight: 600"><?php echo e($data['patient']['first_name']); ?>,</span>
                </p>
                <p class="fs-5">
                    I hope you're well and thanks for booking your
                    <span style=" font-weight: 600">
                        <?php echo e($data['buy_detail']['modal']['name']); ?> </span>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="font-weight: 600">
                                <?php echo e($data['patient']['first_name']); ?> <?php echo e($data['patient']['last_name']); ?>
                        ...
                        <tr>
                            ...
                            <td style=" font-weight: 600">
                                <?php echo e($data['patient']['existing_patient'] ? 'Yes' : 'No'); ?>
                        ...
                        <tr>
                            ...
                            <td style=" font-weight: 600">
                                <?php echo e($data['patient']['business_repair'] ? 'Yes' : 'No'); ?>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 600">
                                <?php echo e($data['patient']['company_name'] ?? 'N/A'); ?>
                ...
                <table class="table table-bordered table-sm border-dark" style="font-size: 1.2rem;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style=" font-weight: 600"><?php echo e($data['buy_detail']['device']['name']); ?></td>
                        </tr>
                        <tr>
                            <td scope="row" style="width: 170px;">Model:</td>
                            <td style=" font-weight: 600"><?php echo e($data['buy_detail']['modal']['name']); ?></td>
                        </tr>

                        <tr>
                            <td scope="row" style="width: 170px;">Memory Size:</td>
                            <td style=" font-weight: 600"><?php echo e($data['buy_detail']['memory_size']); ?></td>
                        </tr>
                        <tr>
                            <td scope="row" style="width: 170px;">Color:</td>
                            <td style=" font-weight: 600"><?php echo e($data['buy_detail']['color']); ?></td>
                        </tr>
                        <tr>
                            <td scope="row" style="width: 170px;">Grade:</td>
                            <td style=" font-weight: 600"><?php echo e($data['buy_detail']['grade']); ?></td>
                        </tr>
                        <tr>
                            <td scope="row" style="width: 170px;">Detail:</td>
                            <td style=" font-weight: 600"><?php echo e($data['buy_detail']['detail']); ?></td>
                        </tr>
                        <tr>
                            <td scope="row" style="width: 170px;">Specification:</td>
                            <td style=" font-weight: 600"><?php echo e($data['buy_detail']['specification']); ?></td>
                        </tr>
                        <tr>
                            <td scope="row" style="width: 170px;">Warranty:</td>
                            <td style=" font-weight: 600"><?php echo e($data['buy_detail']['warranty']); ?></td>
                        </tr>
                        <tr>
                            <td scope="row" style="width: 170px;">Quantity:</td>
                            <td style=" font-weight: 600"> <?php echo e($data['buy_detail']['quantity']); ?></td>
                        </tr>
                        <tr>
                            <td scope="row" style="width: 170px;">Provisional Quote:</td>
                            <td style=" font-weight: 600"> £ <?php echo e($data['buy_detail']['price']); ?></td>
                        </tr>
...
</html><?php /**PATH /home/phonelabs/public_html/resources/views/emails/buy/collect_my_device_temp.blade.php ENDPATH**/ ?>