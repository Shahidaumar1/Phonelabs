...
} elseif ($_instance->childHasBeenRendered('l654089397-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l654089397-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l654089397-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l654089397-0');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l654089397-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            ...
            <div class="row g-4 justify-content-center align-items-stretch">
                            ...
                            <div class="inner-branch-card w-100 mb-3 shadow-sm p-3">
                                <div class="d-flex align-items-start gap-2">
                                    ...
                                    <div class="text-start branch-info-with-map">
                                        <strong class="text-dark d-block mb-1"><?php echo e($siteBranch->name); ?></strong>
                                        <p class="small text-muted mb-0"><?php echo e($siteBranch->address_line_1); ?></p>
                                        <p class="small text-muted mb-0"><?php echo e($siteBranch->town_city); ?>, <?php echo e($siteBranch->post_code); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo e(route('store-details', ['branchSlug' => SeoUrl::encodeUrl($siteBranch->town_city)])); ?>" 
                ...
                <div class="col-lg-4 d-flex">
                    <div class="glass-card p-4 w-100 d-flex flex-column align-items-center">
                        <div class="flex-grow-1 w-100">
                            <div class="inner-branch-card w-100 mb-3 shadow-sm p-3">
                                <div class="d-flex align-items-start gap-2">
                                    <img src="https://ik.imagekit.io/8qyy56iye/Google_Maps_Logo_PNG_Vector__CDR__Free_Download-removebg-preview.png?updatedAt=1776339012558" alt="Location" class="small-map-image mt-1">
                                    <div class="text-start branch-info-with-map">
                                        <?php $secondBranch = $branches->where('id', '!=', $siteBranch->id)->first(); ?>
                                        <?php if($secondBranch): ?>
                                            <strong class="text-dark d-block mb-1"><?php echo e($secondBranch->name); ?></strong>
                                            <p class="small text-muted mb-0"><?php echo e($secondBranch->address_line_1); ?></p>
                                            <p class="small text-muted mb-0"><?php echo e($secondBranch->town_city); ?>, <?php echo e($secondBranch->post_code); ?></p>
                                        <?php else: ?>
                        ...
                        <a href="<?php echo e($secondBranch ? route('store-details', ['branchSlug' => SeoUrl::encodeUrl($secondBranch->town_city)]) : '#'); ?>" 
                           class="btn btn-primary-custom px-4 mt-3"
                           onclick="updateStep(3)">
                            Visit Branch
                        </a>
...
</style><?php /**PATH /home/phonelabs/public_html/resources/views/livewire/guest/stores/index.blade.php ENDPATH**/ ?>