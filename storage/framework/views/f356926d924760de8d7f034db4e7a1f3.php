...
} elseif ($_instance->childHasBeenRendered('l3687125443-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3687125443-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3687125443-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3687125443-0');
} else {
    $response = \Livewire\Livewire::mount('admin.components.side-nave', ['active' => 'orders']);
    $html = $response->html();
    $_instance->logRenderedChild('l3687125443-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes([]); ?>
            ...
            <div class="sticky-top-nav">
                <div wire:ignore>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.orders.components.top-nav', ['active' => 'repair-quotation'])->html();
    ...
    $response = \Livewire\Livewire::mount('admin.orders.components.top-nav', ['active' => 'repair-quotation']);
    $html = $response->html();
            ...
            <div class="container my-4">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $quotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($index + 1); ?></td>
                                    <td><?php echo e($q->device ?? '-'); ?></td>
                                    <td><?php echo e($q->modal ?? '-'); ?></td>
                                    <td><?php echo e($q->repair ?? '-'); ?></td>
                                    <td><?php echo e($q->name ?? '-'); ?></td>
                                    <td><?php echo e($q->email ?? '-'); ?></td>
                                    <td><?php echo e($q->phone ?? '-'); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($q->created_at)->format('d/m/Y h:i A')); ?></td>

                                    <td>
                                        <select class="form-select form-select-sm"
                                            wire:change="updateStatus(<?php echo e($q->id); ?>, $event.target.value)"
                                            style="width: 120px;">
                                            <option value="pending" <?php if($q->status=='pending'): echo 'selected'; endif; ?>>Pending</option>
                                            <option value="approved" <?php if($q->status=='approved'): echo 'selected'; endif; ?>>Approved</option>
                                            <option value="rejected" <?php if($q->status=='rejected'): echo 'selected'; endif; ?>>Rejected</option>
                                            <option value="completed" <?php if($q->status=='completed'): echo 'selected'; endif; ?>>Completed</option>
                                        </select>
                                    </td>

                                    <td>
                                        <?php if($q->deleted_at): ?>
                                            <button wire:click="restoreQuotation(<?php echo e($q->id); ?>)"
                                                class="btn btn-success btn-sm mb-1">
                                                <i class="fa fa-undo"></i> Restore
                                            </button>

                                            <button wire:click="forceDeleteQuotation(<?php echo e($q->id); ?>)"
                                                class="btn btn-danger btn-sm"
                                                onclick="return confirm('Permanently delete this quotation?')">
                                                <i class="fa fa-trash"></i> Delete Forever
                                            </button>
                                        <?php else: ?>
                                            <button wire:click="deleteQuotation(<?php echo e($q->id); ?>)"
...
</div><?php /**PATH /home/phonelabs/public_html/resources/views/livewire/admin/repair-quotations/index.blade.php ENDPATH**/ ?>