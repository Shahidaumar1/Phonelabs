...
} elseif ($_instance->childHasBeenRendered('l3210294157-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3210294157-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3210294157-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3210294157-0');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3210294157-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div class="filter-body pt-0 pt-md-3">
                            ...
                            <div class="nav flex-column gap-1 d-none d-md-flex">
                                <button wire:click="$set('selectedCategoryId', 'All')" 
                                        class="nav-link-prof <?php echo e($selectedCategoryId == 'All' ? 'active' : ''); ?>">
                                    All Accessories
                                </button>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button wire:click="$set('selectedCategoryId', '<?php echo e($cat->id); ?>')" 
                                            class="nav-link-prof <?php echo e($selectedCategoryId == $cat->id ? 'active' : ''); ?>">
                                        <?php echo e($cat->name); ?>
                            ...
                            <div class="category-mobile-grid d-flex d-md-none flex-wrap">
                                <div class="category-mobile-item text-center" wire:click="$set('selectedCategoryId', 'All')">
                                    <div class="category-icon-circle <?php echo e($selectedCategoryId == 'All' ? 'active' : ''); ?>">
                                        <i data-lucide="layout-grid" class="lucide-icon"></i>
                                    </div>
                                    <span class="category-name-label <?php echo e($selectedCategoryId == 'All' ? 'fw-bold text-primary' : ''); ?>">All</span>
                                </div>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="category-mobile-item text-center" wire:click="$set('selectedCategoryId', '<?php echo e($cat->id); ?>')">
                                        <div class="category-icon-circle <?php echo e($selectedCategoryId == $cat->id ? 'active' : ''); ?>">
                                            <?php
                                                $icon = 'package'; 
                                            ...
                                            ?>
                                            <i data-lucide="<?php echo e($icon); ?>" class="lucide-icon"></i> 
                                        </div>
                                        <span class="category-name-label <?php echo e($selectedCategoryId == $cat->id ? 'fw-bold text-primary' : ''); ?>"><?php echo e($cat->name); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                        ...
                        <div class="filter-body">
                            ...
                            <div class="device-tag-container d-none d-md-flex flex-wrap gap-2">
                                <?php $__empty_1 = true; $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <button type="button" 
                                        class="device-tag <?php echo e($selectedDevice && $selectedDevice->id === $device->id ? 'active' : ''); ?>" 
                                        wire:click="selectDevice(<?php echo e($device->id); ?>)">
                            ...
                            <div class="d-block d-md-none">
                                <select class="form-select form-select-sm" wire:change="selectDevice($event.target.value)">
                                    ...
                                    <?php $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($device->id); ?>" <?php echo e($selectedDevice && $selectedDevice->id === $device->id ? 'selected' : ''); ?>>
                                            <?php echo e($device->name); ?>
                        ...
                        <div class="col-6 col-md-6 col-xl-4">
                            <div class="card product-card-compact h-100 border-0 shadow-sm">
                                <div class="card-img-top-white">
                                    <img src="<?php echo e($model->file ?? 'https://via.placeholder.com/300x300?text=Product'); ?>" 
                                         alt="<?php echo e($model->name); ?>">
                                </div>
                                <div class="card-body p-2 p-md-3 d-flex flex-column">
                                    <span class="category-pill"><?php echo e($model->device_type->name ?? 'Universal'); ?></span>
                                    <h6 class="product-title-text"><?php echo e($model->name); ?></h6>
                                    <div class="mt-auto d-flex gap-1 gap-md-2 pt-2">
                                        <a href="<?php echo e(route('guest-accessories-product-specs', [
...
</style><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/livewire/guest/accessories/index.blade.php ENDPATH**/ ?>