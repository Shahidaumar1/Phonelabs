...
} elseif ($_instance->childHasBeenRendered('l2226732745-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2226732745-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2226732745-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2226732745-0');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2226732745-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/livewire/guest/modals.blade.php ENDPATH**/ ?>