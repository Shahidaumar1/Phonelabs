...
} elseif ($_instance->childHasBeenRendered('l556311721-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l556311721-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l556311721-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l556311721-0');
} else {
    $response = \Livewire\Livewire::mount('admin.components.side-nave', ['active' => 'repair']);
    $html = $response->html();
    $_instance->logRenderedChild('l556311721-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes([]); ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.repair.components.top-nav', ['active' => 'categories'])->html();
} elseif ($_instance->childHasBeenRendered('l556311721-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l556311721-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l556311721-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l556311721-1');
} else {
    $response = \Livewire\Livewire::mount('admin.repair.components.top-nav', ['active' => 'categories']);
    $html = $response->html();
    $_instance->logRenderedChild('l556311721-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="container">
...
} elseif ($_instance->childHasBeenRendered('l556311721-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l556311721-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l556311721-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l556311721-2');
} else {
    $response = \Livewire\Livewire::mount('admin.repair.components.sub-nav', ['items' => $items]);
    $html = $response->html();
    $_instance->logRenderedChild('l556311721-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="card border-0 rounded-0 shadow cursor-pointer">
                                <div class="p-1 d-flex justify-content-center align-items-center">
                                      <a href="<?php echo e(route('repair-devices', $category)); ?>" class="d-flex justify-conent-center flex-column align-items-center">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Add Category','id' => 'add-repair-cat']); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.repair.category.create', [])->html();
} elseif ($_instance->childHasBeenRendered('l556311721-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l556311721-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l556311721-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l556311721-3');
} else {
    $response = \Livewire\Livewire::mount('admin.repair.category.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('l556311721-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Category','id' => 'edit-repair-cat']); ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.repair.category.edit', [])->html();
} elseif ($_instance->childHasBeenRendered('l556311721-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l556311721-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l556311721-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l556311721-4');
} else {
    $response = \Livewire\Livewire::mount('admin.repair.category.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l556311721-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
         <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /home/phonelabs/public_html/resources/views/livewire/admin/repair/category/index.blade.php ENDPATH**/ ?>