...
.slect-slot-now button:hover{
    ...
    <form x-data="{ 
        ...
        <div class="global-map-bg">
            <?php if(!empty($setting->map_link)): ?> <?php echo $setting->map_link; ?> <?php endif; ?>
        </div>
        ...
        <div x-show="step === 0" x-transition x-cloak style="display:contents;">
            ...
            <div class="content-scroll-area">
                <div class="branch-grid">
                    <?php $branchSource = !empty($nearestBranches) ? $nearestBranches : $branches; ?>
                    
                    <?php $__currentLoopData = $branchSource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php 
                            ...
                            <div class="card-info-layer">
                                <?php if($bDist): ?>
                                    <div class="distance-badge">
                                        <i class="fa fa-location-arrow"></i> <?php echo e($bDist); ?> mi
                                    </div>
                                <?php endif; ?>

                                <h5 class="branch-title"><?php echo e($bName); ?></h5>

                                <div class="contact-pill-box">
                                    <?php if($phone): ?>
                                        <span class="c-pill"><i class="fa fa-phone"></i> <?php echo e($phone); ?></span>
                                    <?php endif; ?>
                                    <span class="c-pill status-open"><i class="fa fa-circle" style="font-size: 8px;"></i> Open Today</span>
                                </div>

                                <button type="button" class="btn-select-branch" wire:click="selectBranch(<?php echo e($bId); ?>)" @click="step = 1">
                ...
                <div class="selection-flow">
                    <div class="action-capsule" @click="showDate = true">
                        ...
                        <div class="capsule-content">
                            ...
                            <div class="capsule-value">
                                <?php echo e($clinic['appointment_date'] ? Carbon::parse($clinic['appointment_date'])->format('l, M d') : 'Select Date'); ?>
                    ...
                    <div class="action-capsule" @click="showTime = true">
                        ...
                        <div class="capsule-content">
                            ...
                            <div class="capsule-value">
                                <?php echo e($clinic['appointment_time'] ?: 'Select Time'); ?>
                    ...
                    <button type="submit" class="btn-confirm" <?php echo e(empty($clinic['appointment_time']) ? 'disabled' : ''); ?> @click="step = 2">
            ...
            <div class="dialogue-modal" @click.stop>
                ...
                <div class="bg-light rounded-4 p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="fw-bold"><?php echo e($this->currentMonth->format('F Y')); ?></span>
                            ...
                            <?php $__currentLoopData = $this->calendarDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <?php $__currentLoopData = $week; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="p-1">
                                            <div wire:click="selectDate('<?php echo e($day['date']); ?>')"
                                                 @click="showDate = false"
                                                 class="mx-auto d-flex align-items-center justify-content-center <?php echo e($clinic['appointment_date'] === $day['date'] ? 'bg-primary text-white shadow-primary' : ''); ?> <?php echo e($day['disabled'] ? 'opacity-25' : 'cursor-pointer day-hover'); ?>"
            ...
            <div class="dialogue-modal" @click.stop>
                ...
                <div class="cute-time-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="time-pill <?php echo e($clinic['appointment_time'] === $slot ? 'active' : ''); ?>"
                             wire:click="$set('clinic.appointment_time', '<?php echo e($slot); ?>')" @click="showTime = false">
                            <?php echo e($slot); ?>
...
</div><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/livewire/guest/components/clinic-repair-form.blade.php ENDPATH**/ ?>