...
} elseif ($_instance->childHasBeenRendered('l3039618-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3039618-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3039618-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3039618-0');
} else {
    $response = \Livewire\Livewire::mount('admin.components.side-nave', ['active' => 'buy']);
    $html = $response->html();
    $_instance->logRenderedChild('l3039618-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes([]); ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.buy.components.top-nav', ['active' => 'categories'])->html();
} elseif ($_instance->childHasBeenRendered('l3039618-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3039618-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3039618-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3039618-1');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.components.top-nav', ['active' => 'categories']);
    $html = $response->html();
    $_instance->logRenderedChild('l3039618-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="container " >
...
} elseif ($_instance->childHasBeenRendered('l3039618-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3039618-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3039618-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3039618-2');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.components.sub-nav', ['items' => $items]);
    $html = $response->html();
    $_instance->logRenderedChild('l3039618-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="card border-0 rounded-4 cursor-pointer" >
                                <div class="p-2 d-flex justify-content-center align-items-center">
                                   ...
                                   <a href="<?php echo e(route('buy-devices', $category)); ?>"> 
                                        <img src="<?php echo e($category->file ?? '#'); ?>" class="img-fluid" style="height: 140px; width: 200px"/>
                                    </a>
                                </div>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="<?php echo e($rand); ?>">
                                            ...
                                            <li>
                                                    <span class="dropdown-item"
                                                        wire:click="addGradeText('<?php echo e($category->id); ?>')">Add Grade Text</span>
                                            </li>
                                            <li>
                                                <?php if($target == 'Junk'): ?>
...
<?php $component->withAttributes(['title' => 'Add Category','id' => 'add-buy-cat']); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.buy.category.create', [])->html();
} elseif ($_instance->childHasBeenRendered('l3039618-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l3039618-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3039618-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3039618-3');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.category.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3039618-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php $component->withAttributes(['title' => 'Add Grades Text','id' => 'add-grade-text','size' => 'lg']); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.buy.category.grade-text', [])->html();
} elseif ($_instance->childHasBeenRendered('l3039618-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l3039618-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3039618-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3039618-4');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.category.grade-text', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3039618-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php $component->withAttributes(['title' => 'Edit Category','id' => 'edit-buy-cat']); ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.buy.category.edit', [])->html();
} elseif ($_instance->childHasBeenRendered('l3039618-5')) {
    $componentId = $_instance->getRenderedChildComponentId('l3039618-5');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3039618-5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3039618-5');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.category.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3039618-5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
         <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /home/phonelabs/public_html/resources/views/livewire/admin/buy/category/index.blade.php ENDPATH**/ ?>