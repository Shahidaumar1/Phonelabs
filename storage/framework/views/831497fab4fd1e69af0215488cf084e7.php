...
} elseif ($_instance->childHasBeenRendered('s0xbAHA')) {
    $componentId = $_instance->getRenderedChildComponentId('s0xbAHA');
    $componentTag = $_instance->getRenderedChildComponentTagName('s0xbAHA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('s0xbAHA');
} else {
    $response = \Livewire\Livewire::mount('guest.user-dashboard.index', []);
    $html = $response->html();
    $_instance->logRenderedChild('s0xbAHA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
                ...
                <div class="inner-card-v3 right-box-v3">
                    ...
                    <div class="contact-info-grid">
                        <div class="info-item-v3">
                            ...
                            <p><?php echo e($mainBranch->landline_number ?? '+44 7305 856667'); ?></p>
                        </div>
                        <div class="info-item-v3">
                            <i class="fa-solid fa-envelope-open"></i>
                            <p><?php echo e($mainBranch->email ?? 'support@example.com'); ?></p>
                        </div>
                        <div class="info-item-v3">
                            <i class="fa-solid fa-location-dot"></i>
                            <p><?php echo e($mainBranch->address_line_1 ?? '123 Repair St, UK'); ?></p>
                        </div>
                        <div class="info-item-v3">
...
</div><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/frontend/Home_page_sections/formAndLocationSec.blade.php ENDPATH**/ ?>