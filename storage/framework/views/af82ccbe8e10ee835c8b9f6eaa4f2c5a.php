...
} elseif ($_instance->childHasBeenRendered('l1258989797-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1258989797-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1258989797-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1258989797-0');
} else {
    $response = \Livewire\Livewire::mount('admin.components.side-nave', ['active' => 'buy']);
    $html = $response->html();
    $_instance->logRenderedChild('l1258989797-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l1258989797-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1258989797-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1258989797-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1258989797-1');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.components.top-nav', ['active' => 'devices']);
    $html = $response->html();
    $_instance->logRenderedChild('l1258989797-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l1258989797-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1258989797-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1258989797-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1258989797-2');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.components.sub-nav', ['items' => $items]);
    $html = $response->html();
    $_instance->logRenderedChild('l1258989797-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
} elseif ($_instance->childHasBeenRendered('l1258989797-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l1258989797-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1258989797-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1258989797-3');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.device.create', ['category' => $selectedCategory]);
    $html = $response->html();
    $_instance->logRenderedChild('l1258989797-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
} elseif ($_instance->childHasBeenRendered('l1258989797-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l1258989797-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1258989797-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1258989797-4');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.device.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1258989797-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginale6a555649da86b3de44465cdfe004aa4); ?>
<?php endif; ?>
</div><?php /**PATH /home/phonelabs/public_html/resources/views/livewire/admin/buy/device/index.blade.php ENDPATH**/ ?>