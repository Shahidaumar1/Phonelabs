...
} elseif ($_instance->childHasBeenRendered('l3357382041-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3357382041-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3357382041-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3357382041-0');
} else {
    $response = \Livewire\Livewire::mount('admin.components.side-nave', ['active' => 'orders']);
    $html = $response->html();
    $_instance->logRenderedChild('l3357382041-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><?php echo e(\Carbon\Carbon::parse($order->created_at)->format('d/m/Y h:i A')); ?></td>
                                    <td><?php echo e($order->customer_email ?? '-'); ?></td>
                                    <td><?php echo e($order->customer_name ?? '-'); ?></td>
                                    <td>£<?php echo e(number_format($order->amount ?? 0, 2)); ?></td>
                                    <td><?php echo e(str_replace('_', ' ', ucwords($order->payment_method, '_'))); ?></td>
                                    ...
                                    <td>
                                        <select class="form-select form-select-sm"
                                            ...
                                            <option value="approved" <?php if($order->status=='approved'): echo 'selected'; endif; ?>>Approved</option>
                                    ...
                                    <td>
                                        <?php if($order->deleted_at): ?>
                                            <button wire:click="restoreOrder(<?php echo e($order->id); ?>)"
                                                class="btn btn-success btn-sm mb-1">
                                                <i class="fa fa-undo"></i> Restore
                                            </button>

                                            <button wire:click="forceDeleteOrder(<?php echo e($order->id); ?>)"
                                                class="btn btn-danger btn-sm"
                                                onclick="return confirm('Permanently delete this order?')">
                                                <i class="fa fa-trash"></i> Delete Forever
                                            </button>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('orders-details', ['orderDetails' => $order->id])); ?>"
            ...
            class LivewireGoogleDatePicker {
                ...
                updateLivewire() {
                    ...
                    if (typeof Livewire !== 'undefined') {
                        window.livewire.find('<?php echo e($_instance->id); ?>').set('fromDate', formatForLivewire(this.startDate));
                        window.livewire.find('<?php echo e($_instance->id); ?>').set('toDate', formatForLivewire(this.endDate));
...
</div><?php /**PATH /home/phonelabs/public_html/resources/views/livewire/admin/orders/index.blade.php ENDPATH**/ ?>