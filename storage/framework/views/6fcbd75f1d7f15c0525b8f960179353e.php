...
} elseif ($_instance->childHasBeenRendered('l3213900359-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3213900359-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3213900359-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3213900359-0');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3213900359-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/livewire/guest/device-typs.blade.php ENDPATH**/ ?>