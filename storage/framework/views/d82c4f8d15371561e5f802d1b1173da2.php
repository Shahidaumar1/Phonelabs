...
} elseif ($_instance->childHasBeenRendered('l2958987786-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2958987786-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2958987786-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2958987786-0');
} else {
    $response = \Livewire\Livewire::mount('components.top-bar', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2958987786-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>-->
        <?php
...
} elseif ($_instance->childHasBeenRendered('l2958987786-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2958987786-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2958987786-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2958987786-1');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', ['theme' => 'white']);
    $html = $response->html();
    $_instance->logRenderedChild('l2958987786-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <div class="bg-color">
            <div class="container-fluid">
                ...
                <div class="card border-0 about-fone-card my-3">
                    ...
                    <p class="lh-lg" style="text-align: justify; ">
                        ...
                        Welcome to <strong><?php echo e($siteSettings->buisness_name); ?></strong>, where innovation meets reliability in the world of mobile phones. <strong><?php echo e($siteSettings->buisness_name); ?></strong> has been at the
                        ...
                        <strong><?php echo e($siteSettings->buisness_name); ?></strong> embarked on its journey with a vision to revolutionize the mobile phone retail
                        ...
                        At <strong><?php echo e($siteSettings->buisness_name); ?></strong>, we understand that your mobile device is not just a gadget; it's an essential
                        ...
                        device? <strong><?php echo e($siteSettings->buisness_name); ?></strong> provides a hassle-free selling experience. We offer competitive prices for
                        ...
                        We understand the frustration of a broken or malfunctioning mobile phone. <strong><?php echo e($siteSettings->buisness_name); ?></strong> is your
                        ...
                        <span style= "font-size:29px; font-weight:bolder;">The <strong><?php echo e($siteSettings->buisness_name); ?></strong> Advantage
                        </span><br>

                        <span style= "font-size:25px; font-weight:bolder;">1. Expertise:
                        </span><br>

                        Our team of experts at <strong><?php echo e($siteSettings->buisness_name); ?></strong> possesses extensive knowledge and expertise in the mobile
                        ...
                        With multiple stores across the UK, <strong><?php echo e($siteSettings->buisness_name); ?></strong> has built a wide network to cater to the diverse
                        ...
                        Quality is at the core of everything we do at <strong><?php echo e($siteSettings->buisness_name); ?></strong>. Whether it's selling new devices,
                        ...
                        At <strong><?php echo e($siteSettings->buisness_name); ?></strong>, we believe in giving back to the community that has supported us throughout our
                        ...
                        As a responsible business, <strong><?php echo e($siteSettings->buisness_name); ?></strong> is committed to environmental sustainability. We actively
                        ...
                        The future holds exciting possibilities for <strong><?php echo e($siteSettings->buisness_name); ?></strong>. We are committed to staying at the
                        ...
                        needs in the UK.
                        In conclusion, <strong><?php echo e($siteSettings->buisness_name); ?></strong> is not just a mobile phone store; it's a destination where technology
                        meets trust. Whether you're buying, selling, or repairing a mobile device, you can rely on
                        <strong><?php echo e($siteSettings->buisness_name); ?></strong> for a seamless and satisfying experience. Join us on our journey as we continue to
...
<?php /**PATH /home/phonelabs/public_html/resources/views/livewire/guest/aboutus.blade.php ENDPATH**/ ?>