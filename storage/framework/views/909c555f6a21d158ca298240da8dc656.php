...
.professional-grid .professional-card:nth-child(3) .card-icon {
    ...
    <div class="form-toggle-wrapper">
        ...
        <?php if($showGrid): ?>
            <div class="professional-container" wire:key="grid-view-container">
                <div class="professional-header">
                    <h1 class="professional-heading"><?php echo e($heading[$formService] ?? ''); ?></h1>
                </div>

                <div class="professional-grid">
                    <?php if(isset($formStatuses[0]) && !empty($formStatuses[0]->$formService)): ?>
                        <div class="professional-card" wire:click="showForm('clinic_form')" wire:key="card-clinic">
                            ...
                            <h3 class="card-title"><?php echo e($optionLabels['Store Repair']); ?></h3>
                    ...
                    <?php if(isset($formStatuses[1]) && !empty($formStatuses[1]->$formService)): ?>
                        <div class="professional-card" wire:click="showForm('postal_form')" wire:key="card-postal">
                            ...
                            <h3 class="card-title"><?php echo e($optionLabels['Postal Repair']); ?></h3>
                    ...
                    <?php if(isset($formStatuses[2]) && !empty($formStatuses[2]->$formService) && $formService !== 'buy'): ?>
                        <div class="professional-card" wire:click="showForm('collection_form')" wire:key="card-collection">
                            ...
                            <h3 class="card-title"><?php echo e($optionLabels['Collect My Device']); ?></h3>
                    ...
                    <?php if($formService === 'repair' && isset($formStatuses[3]) && !empty($formStatuses[3]->$formService) && !empty($data['device']['name'] ?? null) && $data['device']['name'] !== 'Apple iPad'): ?>
                        <div class="professional-card" wire:click="showForm('fix_form')" wire:key="card-fix">
                            ...
                            <h3 class="card-title"><?php echo e($optionLabels['Call Out Repair']); ?></h3>
        ...
        <?php if($showForm): ?>
            <div class="professional-form-section" wire:key="form-view-section-<?php echo e($form_type); ?>">
                    ...
                    <div class="form-wrapper">
                        ...
                        <div class="form-content">
                            <?php if($form_type == 'postal_form'): ?>
                                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('guest.components.postal-repair-form', ['initialBranchId' => '13'])->html();
} elseif ($_instance->childHasBeenRendered('postal-'.uniqid())) {
    $componentId = $_instance->getRenderedChildComponentId('postal-'.uniqid());
    $componentTag = $_instance->getRenderedChildComponentTagName('postal-'.uniqid());
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('postal-'.uniqid());
} else {
    $response = \Livewire\Livewire::mount('guest.components.postal-repair-form', ['initialBranchId' => '13']);
    $html = $response->html();
    $_instance->logRenderedChild('postal-'.uniqid(), $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('clinic-'.uniqid())) {
    $componentId = $_instance->getRenderedChildComponentId('clinic-'.uniqid());
    $componentTag = $_instance->getRenderedChildComponentTagName('clinic-'.uniqid());
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('clinic-'.uniqid());
} else {
    $response = \Livewire\Livewire::mount('guest.components.clinic-repair-form', []);
    $html = $response->html();
    $_instance->logRenderedChild('clinic-'.uniqid(), $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('collection-'.uniqid())) {
    $componentId = $_instance->getRenderedChildComponentId('collection-'.uniqid());
    $componentTag = $_instance->getRenderedChildComponentTagName('collection-'.uniqid());
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('collection-'.uniqid());
} else {
    $response = \Livewire\Livewire::mount('guest.collection-form', []);
    $html = $response->html();
    $_instance->logRenderedChild('collection-'.uniqid(), $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('fix-'.uniqid())) {
    $componentId = $_instance->getRenderedChildComponentId('fix-'.uniqid());
    $componentTag = $_instance->getRenderedChildComponentTagName('fix-'.uniqid());
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fix-'.uniqid());
} else {
    $response = \Livewire\Livewire::mount('guest.fix-form', []);
    $html = $response->html();
    $_instance->logRenderedChild('fix-'.uniqid(), $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <?php endif; ?>
    ...
    <script>
        ...
        function forgetPreviousForm() {
            window.livewire.find('<?php echo e($_instance->id); ?>').forgetSession('form_type');
        }
    </script>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            function forgetPreviousForm() {
                window.livewire.find('<?php echo e($_instance->id); ?>').call('forgetFormType');
            }
            document.addEventListener('livewire:load', function () {
...
</div><?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/livewire/guest/components/form-toggle.blade.php ENDPATH**/ ?>