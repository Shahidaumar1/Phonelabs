...
} elseif ($_instance->childHasBeenRendered('9AIVSOj')) {
    $componentId = $_instance->getRenderedChildComponentId('9AIVSOj');
    $componentTag = $_instance->getRenderedChildComponentTagName('9AIVSOj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9AIVSOj');
} else {
    $response = \Livewire\Livewire::mount('guest.user-dashboard.index', []);
    $html = $response->html();
    $_instance->logRenderedChild('9AIVSOj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
</div><?php /**PATH /home/phonelabs/public_html/resources/views/frontend/Home_page_sections/formAndLocationSec.blade.php ENDPATH**/ ?>