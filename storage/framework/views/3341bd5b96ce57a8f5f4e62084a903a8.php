...
} elseif ($_instance->childHasBeenRendered('l3961746681-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3961746681-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3961746681-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3961746681-0');
} else {
    $response = \Livewire\Livewire::mount('admin.components.side-nave', ['active' => 'buy']);
    $html = $response->html();
    $_instance->logRenderedChild('l3961746681-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $component->withAttributes([]); ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.buy.components.top-nav', ['active' => 'models'])->html();
} elseif ($_instance->childHasBeenRendered('l3961746681-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3961746681-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3961746681-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3961746681-1');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.components.top-nav', ['active' => 'models']);
    $html = $response->html();
    $_instance->logRenderedChild('l3961746681-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="container">
...
} elseif ($_instance->childHasBeenRendered('l3961746681-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3961746681-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3961746681-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3961746681-2');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.components.sub-nav', ['items' => $items]);
    $html = $response->html();
    $_instance->logRenderedChild('l3961746681-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-center gap-4 flex-wrap pb-5 sortable-buy">
                            <?php $__empty_1 = true; $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="card rounded-4 cursor-pointer" data-id="<?php echo e($model->id); ?>">
                                    <div class="p-2 d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="dropdown dropend" id="<?php echo e(uniqid()); ?>" wire:ignore>
                                            <button class="btn btn-light dropdown-toggle border-0" type="button"
                                                id="<?php echo e(uniqid()); ?>" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                    ...
                                    <div class="p-2 d-flex justify-content-center align-items-center">
                                        <a href="<?php echo e(route('buy-models-add-ons')); ?>" class="position-relative">
...
<?php $component->withAttributes(['title' => 'Add Model','id' => 'add-buy-model']); ?>
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.buy.model.create', ['device' => $selectedDevice])->html();
} elseif ($_instance->childHasBeenRendered('l3961746681-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l3961746681-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3961746681-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3961746681-3');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.model.create', ['device' => $selectedDevice]);
    $html = $response->html();
    $_instance->logRenderedChild('l3961746681-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
         <?php echo $__env->renderComponent(); ?>
...
<?php $component->withAttributes(['title' => 'Edit Model','id' => 'edit-buy-model']); ?>
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.buy.model.edit', [])->html();
} elseif ($_instance->childHasBeenRendered('l3961746681-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l3961746681-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3961746681-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3961746681-4');
} else {
    $response = \Livewire\Livewire::mount('admin.buy.model.edit', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3961746681-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     <?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /home/phonelabs/public_html/resources/views/livewire/admin/buy/model/index.blade.php ENDPATH**/ ?>