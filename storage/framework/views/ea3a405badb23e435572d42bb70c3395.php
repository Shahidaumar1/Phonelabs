...
} elseif ($_instance->childHasBeenRendered('l3124049390-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3124049390-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3124049390-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3124049390-0');
} else {
    $response = \Livewire\Livewire::mount('components.mega-nav', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3124049390-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php /**PATH C:\Users\AL-RASHEEED\Downloads\idea (9)\resources\views/livewire/guest/buy/index.blade.php ENDPATH**/ ?>